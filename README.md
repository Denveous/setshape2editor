...
- Grid-snapping selection tools

## Controls
- Left click: Draw tile types
- Right click: Erase tile types
- Middle mouse button: Pan view
- Mouse wheel: Zoom in/out
- Shift + click: Snap select to grid (in cut mode)

## Usage
1. Load an image using the "Load Image" button
2. Select a tile type from the left panel
3. Draw your shape
